...
export default function SignInPage() {
  ...
  const handleGoogleLogin = useCallback(async () => {
    ...
    // on success, browser redirects away; loading stays true
  }, [])
  ...
  return (
    <div className="min-h-screen flex" style={{ backgroundColor: '#FBFBFB' }}>
      ...
      <div className="flex-1 flex items-center justify-center relative" style={{ backgroundColor: '#FBFBFB' }}>
        ...
        >
          <span className="text-body-sm text-[#666666]">Don&apos;t have an account?</span>
          <button
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-body-sm text-[#666666]" style={{ marginBottom: '32px' }}>
            Sign in to access your API keys, manage billing, and track usage.
          </motion.p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {/* Forgot Password */}
            <motion.div variants={itemVariants} className="text-right" style={{ marginBottom: '24px' }}>
              <button
                type="button"
                onClick={() => alert('Password reset coming soon')}
                className="font-display text-[#666666] hover:text-[#1E1E1E] transition-colors duration-300 uppercase"
                style={{ fontWeight: 400, fontSize: '11px', letterSpacing: '0.08em' }}
              >
                FORGOT PASSWORD?
              </button>
            </motion.div>
